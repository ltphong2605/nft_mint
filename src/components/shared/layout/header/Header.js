            ...
            <nav className="main-nav " >
                <S.SubMenu className={boxClass.join(' ')}>
                    <li  className="menu-item" >
                        <Link to="about" spy={true} smooth={true} offset={0} duration={1000} style={{color: themes.gray['4']}}> About </Link> 
                    </li>
                    <li  className="menu-item" >
                        <Link to="mint" spy={true} smooth={true} offset={-90} duration={1000} style={{color: themes.gray['4']}}> Mint </Link> 
                    </li>
                    <li className="menu-item " ><Link to="roadmap" spy={true} smooth={true} offset={-100} duration={1000} style={{color: themes.gray['4']}}> RoadMap </Link></li>
                    <li className="menu-item " ><Link to="team" spy={true} smooth={true} offset={0} duration={1000} style={{color: themes.gray['4']}}> Team </Link> </li>
                    </S.SubMenu>
            </nav>     
        </div> 
        <WalletButton />
